...
8. **WhatsApp: resume ke saath message bhi jaata hai (fix)** — pehle kabhi-kabhi caption box
   (jahan message type hota hai) nahi milta tha, isliye sirf resume jaata tha, message chhoot
   jaata tha. Ab caption box dhoondhne ke zyada tareeke try hote hain, type karne ke baad
   VERIFY kiya jaata hai ki text sach mein gaya ya nahi, aur agar phir bhi na jaaye to message
   turant ek ALAG normal text message ke roop mein bhej diya jaata hai — taaki message kabhi
   miss na ho.
9. **Bulk Email / Bulk WhatsApp (naya)** — **View Jobs** screen me ab har row ke aage ek ✓
   checkbox hai. Jitni applications चाहिए utni tick karo (ya "Select All" se ek click me sab),
   phir **"📧 Bulk Email (Selected)"** ya **"💬 Bulk WhatsApp (Selected)"** button dabao — sabko
   ek ke baad ek, live progress ke saath, resume-attached Email/WhatsApp chala jaayega. Ek
   progress window me har contact ka result (✅/⚠️) dikhta hai.
   > ⚠️ **WhatsApp bulk send risk:** WhatsApp Web par bahut jaldi-jaldi bahut saare messages
   > bhejna number ko temporarily/permanently block kar sakta hai (WhatsApp ki apni policy hai,
   > isse bachne ka koi 100% guaranteed tareeka nahi). Isliye har WhatsApp message ke beech
   > jaan-bujh kar ek delay (~10-18 sec) rakha gaya hai, aur button dabate hi ek warning bhi
   > dikhti hai. Agar risk lena avoid karna ho, **Bulk Email use karo** — usme yeh risk nahi hai.
